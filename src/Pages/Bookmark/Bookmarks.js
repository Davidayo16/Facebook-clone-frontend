...
const Bookmarks = () => {
  ...
  return (
    <div className="bookmark-wrapper mt-3">
      <div className="container-xxl">
        <div className="row">
          <div className="col-12">
            <ul className="px-0">
              <Link to={`/profile/${userInfo?._id}`}>
                <li className="d-flex align-items-center mb-2 gap-3 allowed">
                  <img
                    src={
              ...
              <Link to={`/friends`}>
                <li className="d-flex align-items-center mb-3 gap-3 allowed">
                  <PeopleRoundedIcon
                    style={{ fontSize: "2.5rem", color: "rgb(25, 154, 177)" }}
                  />
                  <span>Friends</span>
                </li>
              </Link>
              ...
              <li className="d-flex align-items-center n-a mb-3 gap-3">
                <Groups2RoundedIcon
                  style={{
                    fontSize: "2.5rem",
              ...
              <li
                className="d-flex align-items-center allowed mb-3 gap-3"
